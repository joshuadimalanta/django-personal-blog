...
from django.views.generic import (TemplateView,
                                    ...
                                    UpdateView,
                                    DeleteView,)
from django.contrib.auth.decorators import login_required #for function-based
...
class CreatePostView(LoginRequiredMixin,CreateView):
    # LoginRequiredMixin = if not logged in, where to go
    login_url = '/login/'
...
class PostDeleteView(LoginRequiredMixin,DeleteView):
    model = Post
    # activate success url only after deleting, use reverselazy
